...
import IconCities from "assets/images/icon/cities-icon.svg";
import IconTraveler from "assets/images/icon/travel-icon.svg";
import IconTreasure from "assets/images/icon/treasure-icon.svg";
